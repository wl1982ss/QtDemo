    ...
    ui(new Ui::MainWindow)
{
    ...
    //player->setMedia(QUrl::fromLocalFile("D:\\Project\\Qt_Project\\gequ.mp3"));
    ...
    playlist->addMedia(QUrl::fromLocalFile("D:\\Project\\Qt_Project\\gequ.mp3"));
    playlist->addMedia(QUrl::fromLocalFile("D:\\Project\\Qt_Project\\gequ1.mp3"));
    playlist->addMedia(QUrl::fromLocalFile("D:\\Project\\Qt_Project\\gequ2.mp3"));
...
void MainWindow::showError(QMediaPlayer::Error error)
{
    ...
    case QMediaPlayer::ResourceError:
        ui->label_3->setText(tr("媒体资源无法解析!"));
        break;
